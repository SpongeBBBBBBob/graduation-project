...
echo "Running run_test with save_frames (max $MAX_FRAMES frames)..."
# checkpoint path (override via CHECKPOINT env var)
CHECKPOINT=${CHECKPOINT:-"output/single_task/ckpt_run.pth"}
